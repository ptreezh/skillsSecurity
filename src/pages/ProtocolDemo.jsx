...
export default function ProtocolDemo({ initialTab = "standard" }) {
  ...
  const loadLiveData = async () => {
    try {
      const { skills } = await ChainDataService.fetchSkills({
        page: 1,
        pageSize: 10,
      });
  ...
  const riskLevels = (t("demo.risk.levels", { returnObjects: true }) || []).map(
    (r) => ({
      ...r,
  ...
  const handleFileUpload = async (event) => {
    ...
    setUploadStatus({
      status: "uploading",
      message: t("demo.status.uploading"),
    });
    ...
    try {
      const result = await fullAuditFlow(file, {
        ...
        onError: (error) =>
          setUploadStatus({ status: "error", message: error.error }),
      });
        ...
        >
          ...
          {!isDemoMode && (
            <button
              ...
              onClick={
                walletConnected ? handleWalletDisconnect : handleWalletConnect
              }
            >
  ...
  const renderLiveStats = () => (
    <div className="grid-stats" style={{ marginBottom: "var(--space-6)" }}>
      {[
        ...
        {
          label: t("demo.live.onChainSkills"),
          value: liveSkills.length,
      ...
      >
        {tabs.map((tab) => (
          <button
            ...
            className={
              activeTab === tab.id ? "app-nav-btn active" : "app-nav-btn"
            }
            style={{
      ...
      <main>
                    ...
                    >
                      ...
                      >
                        <div>
                          ...
                          >
                            {skill.description || t("demo.live.noDescription")}
                          </div>
                        </div>
                        <span
                          className={`badge ${skill.verified ? "badge-success" : "badge-warning"}`}
                        >
                          {skill.verified
                      ...
                      >
                        <span>
                          {t("browser.filters.riskLevel")}:{" "}
                          {skill.riskLevel || "LOW"}
                        </span>
                        <span>
                          {t("demo.live.stake")}:{" "}
                          {skill.stakeAmount
                            ? `${Number(skill.stakeAmount) / 1e18} RP`
                            : "0"}
                        </span>
                        {skill.fingerprint && (
                          <span style={{ fontFamily: "var(--font-mono)" }}>
                            {skill.fingerprint.slice(0, 10)}...
                          </span>
                        )}
                      </div>
                    </div>
        ...
        {activeTab === "standard" && (
          <section className="animate-fade-in">
            ...
            <div className="card" style={{ marginBottom: "var(--space-6)" }}>
              ...
              >
                {t("demo.standard.coreComponents")}
              </h3>
              <div className="grid-auto">
                {(
                  t("demo.standard.components", { returnObjects: true }) || []
                ).map((comp, i) => (
                  <div
                    key={i}
                    className="card"
                  ...
                  >
                    ...
                    <span className={`badge badge-${comp.variant}`}>
                      {comp.status}
                    </span>
                  </div>
                ))}
            ...
            >
              ...
              >
                {t("demo.standard.protocolFeatures")}
              </h3>
              <div style={{ display: "grid", gap: "var(--space-3)" }}>
                {(
                  t("demo.standard.features", { returnObjects: true }) || []
                ).map((item, i) => (
                  <div
                    key={i}
                    style={{
        ...
        {activeTab === "fingerprint" && (
          <section className="animate-fade-in">
            ...
            <div className="card" style={{ marginBottom: "var(--space-6)" }}>
              ...
              >
                {(
                  t("demo.fingerprint.inputs", { returnObjects: true }) || []
                ).map((item, i) => (
                  <div
                    key={i}
                    className="card"
        ...
        {activeTab === "antislas" && (
          <section className="animate-fade-in">
            ...
            <div style={{ display: "grid", gap: "var(--space-3)" }}>
              {(
                t("demo.antislas.penalties", { returnObjects: true }) || []
              ).map((item, i) => (
                <div
                  key={i}
                  className="card"
            ...
            >
              ...
              >
                {(
                  t("demo.antislas.appealSteps", { returnObjects: true }) || []
                ).map((step, i, arr) => (
                  <div
                    key={i}
                    style={{
        ...
        {activeTab === "register" && (
          <section className="animate-fade-in">
            ...
            <div
              className="card upload-entry-banner"
              ...
              <div className="upload-entry-content">
                ...
                <div className="upload-entry-actions">
                  <button
                    ...
                    onClick={() => setActiveTab("freeskill")}
                  >
            ...
            >
              ...
              >
                {uploadStatus?.status === "uploading"
                  ? t("demo.register.processing")
                  : t("demo.register.selectFile")}
              </button>
              ...
              {uploadStatus && (
                ...
                >
                  <div style={{ fontWeight: "var(--font-semibold)" }}>
                    {uploadStatus.status === "uploading" &&
                      t("demo.status.uploading")}
                    {uploadStatus.status === "pending" &&
                      t("demo.status.pending")}
                    {uploadStatus.status === "auditing" &&
                      t("demo.status.auditing")}
                    {uploadStatus.status === "approved" &&
                      t("demo.status.approved")}
                    {uploadStatus.status === "review" &&
                      t("demo.status.review")}
                    {uploadStatus.status === "rejected" &&
                      t("demo.status.rejected")}
                    {uploadStatus.status === "submitting" &&
                      t("demo.status.submitting")}
                    {uploadStatus.status === "on_chain" &&
                      t("demo.status.onChain")}
                  ...
                  {uploadStatus.message && (
                    ...
                    >
                      {uploadStatus.status === "error" &&
                      REPUTATION_ERROR_RE.test(uploadStatus.message)
              ...
              {uploadResult && (
                <div
                  className={`alert alert-${uploadResult.success ? "success" : "danger"}`}
                  style={{ marginTop: "var(--space-4)", textAlign: "left" }}
                >
                  {uploadResult.success ? (
                    <>
                      ...
                      >
                        {t("demo.chain.success")}
                      </div>
                      <div style={{ fontSize: "var(--text-sm)" }}>
                        <div>
                          {t("demo.chain.skillId")}:{" "}
                          <code>{uploadResult.skillId}</code>
                        </div>
                        <div>
                          {t("demo.chain.txHash")}:{" "}
            ...
            <div className="card">
              ...
              >
                ...
                >
                  ...
                  >
                    {t("demo.register.baseFieldsLabel")}
                  </div>
                  <code
                    style={{
                      fontFamily: "var(--font-mono)",
                ...
                >
                  ...
                  >
                    {t("demo.register.extensionFieldsLabel")}
                  </div>
                  <code
                    style={{
                      fontFamily: "var(--font-mono)",
            ...
            >
              ...
              >
                {(
                  t("demo.register.workflowSteps", { returnObjects: true }) ||
                  []
                ).map((step, i, arr) => (
                  <div
                    key={i}
        ...
        {activeTab === "freeskill" && (
          <section className="animate-fade-in">
            ...
            >
              {t("demo.freeskill.responsibilityChain")}
            </h3>
            <div
              className="card"
              style={{
            ...
            >
              ...
              >
                {(
                  t("demo.freeskill.chainSteps", { returnObjects: true }) || []
                ).map((step, i, arr) => (
                  <div
                    key={i}
                    style={{
            ...
            >
              {t("demo.freeskill.comparisonTitle")}
            </h3>
            <div
              className="card"
              style={{
              ...
              >
                <thead>
                  <tr style={{ background: "var(--color-bg-secondary)" }}>
                    ...
                    >
                      {t("demo.freeskill.comparisonRegular")}
                    </th>
                    <th
                      style={{
                        padding: "var(--space-3) var(--space-4)",
                    ...
                    >
                      {t("demo.freeskill.comparisonFreeskill")}
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {(
                    t("demo.freeskill.comparisonDimensions", {
                      returnObjects: true,
                    }) || []
                  ).map((dim, i) => (
                    <tr
            ...
            >
              {t("demo.freeskill.requiredFieldsTitle")}
            </h3>
            <div
              style={{
                background: "var(--color-gray-800)",
            ...
            >
              <pre style={{ margin: 0, whiteSpace: "pre-wrap" }}>
                {t("demo.freeskill.requiredFieldsCode")}
              </pre>
            </div>
            ...
            >
              {t("demo.freeskill.collaborationTitle")}
            </h3>
            <div
              className="grid-auto"
              style={{ marginBottom: "var(--space-6)" }}
            >
              {(
                t("demo.freeskill.collaborationSkills", {
                  returnObjects: true,
                }) || []
              ).map((skill, i) => (
                <div
            ...
            >
              {t("demo.freeskill.authCheckpointsTitle")}
            </h3>
            <div
              className="card"
              style={{
              ...
              <table style={{ width: "100%", fontSize: "var(--text-sm)" }}>
                <thead>
                  <tr>
                    ...
                    >
                      {t("demo.freeskill.authStepHeader")}
                    </th>
                    <th
                      style={{
                        textAlign: "left",
                    ...
                    >
                      {t("demo.freeskill.authContentHeader")}
                    </th>
                    <th
                      style={{
                        textAlign: "left",
                    ...
                    >
                      {t("demo.freeskill.authTriggerHeader")}
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {(
                    t("demo.freeskill.authRows", { returnObjects: true }) || []
                  ).map((row, i) => (
                    <tr
                      key={i}
                      style={{
                        borderTop: "1px solid var(--risk-medium-border)",
                      }}
                    >
                      <td
                        style={{
        ...
        {activeTab === "templates" && (
          <section className="animate-fade-in">
            ...
            >
              {(
                t("demo.templates.templateList", { returnObjects: true }) || []
              ).map((skill, i) => (
                <div
                  key={i}
                  className="card"
                ...
                >
                  ...
                  <div className="grid-auto" style={{ gap: "var(--space-3)" }}>
                    {[
                      {
                        label: t("demo.templates.stats.riskLevel"),
                        value: "MEDIUM",
                        variant: "warning",
                      },
                      {
                        label: t("demo.templates.stats.validators"),
                        value: "2",
                        variant: "info",
                      },
                      {
                        label: t("demo.templates.stats.stake"),
                        value: "50 ether",
                        variant: "success",
                      },
                    ].map((stat, j) => (
            ...
            >
              {t("demo.templates.governanceFieldsTitle")}
            </h3>
              ...
              >
                <thead>
                  <tr style={{ background: "var(--color-bg-secondary)" }}>
                    ...
                    >
                      {t("demo.templates.descHeader")}
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {(
                    t("demo.templates.governanceFields", {
                      returnObjects: true,
                    }) || []
                  ).map((row, i) => (
                    <tr
